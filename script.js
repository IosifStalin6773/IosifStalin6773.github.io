...
const DATOS = {
  ...
  niveles: [
    ...
    /* ---------- 2-3 CERTIFICACIONES (BADGES) ---------- */
    {
      ...
      items: [
        ...
        },
        {
          ...
          fecha: "15 ABR 2026",
          badge:
            "https://images.credly.com/images/3f802526-7274-4230-91ab-f6d1a35340e6/image.png",
          verificacion: "https://www.credly.com/users/oscar-de-la-cruz-diez",
          resumen:
        ...
        },
        {
          ...
          fecha: "13 ABR 2026",
          badge:
            "https://images.credly.com/images/68c0b94d-f6ac-40b1-a0e0-921439eb092e/image.png",
          verificacion: "https://www.credly.com/users/oscar-de-la-cruz-diez",
          resumen:
            "Introducción al lenguaje Python: sintaxis, variables, tipos de datos, operadores, estructuras de control, funciones, listas, tuplas, diccionarios y manejo básico de errores. Certificación que acredita las bases sólidas del lenguaje más demandado para automatización, scripting y ciencia de datos.",
        },
        {
          ...
          verificacion: "https://www.credly.com/users/oscar-de-la-cruz-diez",
          resumen:
            "Introducción a la ciberseguridad: panorama actual de amenazas, tipos de malware, ingeniería social, vulnerabilidades comunes, criptografía básica, seguridad en redes, protección de datos y buenas prácticas. Primer paso hacia la especialización en Seguridad Informática que el perfil tiene como objetivo.",
        },
        {
          ...
          verificacion: "https://www.credly.com/users/oscar-de-la-cruz-diez",
          resumen:
            "Fundamentos de redes: modelo OSI y TCP/IP, direccionamiento IPv4/IPv6, protocolos (HTTP, DNS, DHCP, etc.), dispositivos de red (switches, routers), cableado, topologías y troubleshooting básico. Base técnica para el Grado Superior en ASIR y la especialización en ciberseguridad.",
        },
      ],
    },
    ...
    /* ---------- 3-1 CONTACTO ---------- */
    {
      ...
      items: [
        {
          label: "EMAIL: oscarcrudi@gmail.com",
          href: "mailto:oscarcrudi@gmail.com",
        },
        { label: "TELÉFONO: 652 630 745", href: "tel:+34652630745" },
        {
          label: "GITHUB: /IosifStalin6773",
          href: "https://github.com/IosifStalin6773",
        },
        {
          label: "LINKEDIN: /in/oscar-de-la-cruz",
          href: "https://www.linkedin.com/in/oscar-de-la-cruz-5402b7406",
        },
        {
          label: "CREDLY: /users/oscar-de-la-cruz-diez",
          href: "https://www.credly.com/users/oscar-de-la-cruz-diez",
        },
        {
          label: "UBICACIÓN: Santander, España",
          href: "https://maps.google.com/?q=Santander,España",
        },
      ],
    },
  ],
...
function updateMenu() {
  document
    ...
    .forEach((li, i) => li.classList.toggle("sel", i === menuIndex));
...
function openLevel(index) {
  ...
  switch (nivel.tipo) {
    ...
    case "badges":
      html =
        `<p class="para reveal">> PULSA SOBRE UN BADGE PARA VER LOS DETALLES:</p>
    ...
    case "contacto":
      html =
        `<p class="para reveal">> ¡GRACIAS POR JUGAR! CONTACTA CONMIGO:</p>` +
        nivel.items
          .map(
            (c) =>
